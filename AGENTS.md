...
- Recipe video: recipes may contain one photo or one video. Videos may be selected or recorded in-browser, are limited to 35 seconds and 50 MB before processing, and the VPS validates duration then transcodes them to MP4 H.264. Playback stays inside cards/detail pages with seek, fullscreen, 1×/1.5×/2× speed, and press-and-hold temporary 2×.
